...
for files in sorted(pathlist):
    ...
    with open(files) as file:
        for line in file:
            ...
            if result:
                precision = int(int(result.group(1)) / 1)
