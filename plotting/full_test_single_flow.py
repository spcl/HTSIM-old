...
# List Experiments
list_experiments = os.listdir('../sim/lgs/input/single_flow')
...
for os_rat in list_os:
    if (os_rat == 1):
        FOLDER="400_SINGLEFLOW_NO_OS_{}".format(1)
    else:
        FOLDER="400_SINGLEFLOW_OS4:1_{}".format(1)
