...
echo ${CMD}
eval ${CMD}
CMD="../sim/datacenter/htsim_uec_entry_modern_os -k 4 -o uec_entry -nodes 64 -q 118500 -strat perm -kmin 20 -target_rtt_percentage_over_base 50 -kmax 80  -linkspeed 100000 -mtu 2048 -seed 919 -queue_type composite -hop_latency 700 -switch_latency 0 -reuse_entropy 1 -goal permutation_64_2000.bin  -number_entropies -1 -fast_drop 1 -algorithm delayB -x_gain ${X_GAIN} -y_gain ${Y_GAIN} -w_gain ${W_GAIN} -z_gain ${Z_GAIN} -bonus_drop 0.8 -collect_data 1 -use_fast_increase 1 -use_super_fast_increase 1 > QuickExp/P"
echo ${CMD}
eval ${CMD}
...
echo ${CMD}
eval ${CMD}
CMD="python3 fct.py --input_file=P --folder=QuickExp --name=100G_Perm_Small"
echo ${CMD}
eval ${CMD}
CMD="../sim/datacenter/htsim_uec_entry_modern_os -k 4 -o uec_entry -nodes 64 -q 118500 -strat perm -kmin 20 -target_rtt_percentage_over_base 50 -kmax 80  -linkspeed 100000 -mtu 2048 -seed 919 -queue_type composite -hop_latency 700 -switch_latency 0 -reuse_entropy 1 -goal permutation_64_20000.bin  -number_entropies -1 -fast_drop 1 -algorithm delayB -x_gain ${X_GAIN} -y_gain ${Y_GAIN} -w_gain ${W_GAIN} -z_gain ${Z_GAIN} -bonus_drop 0.8 -collect_data 1 -use_fast_increase 1 -use_super_fast_increase 1 > QuickExp/P"
echo ${CMD}
eval ${CMD}
...
echo ${CMD}
eval ${CMD}
CMD="python3 fct.py --input_file=P --folder=QuickExp --name=100G_Perm_Large"
echo ${CMD}
eval ${CMD}