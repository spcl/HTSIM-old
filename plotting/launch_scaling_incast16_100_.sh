...
for Item in incast_128_16_2.bin incast_128_16_4.bin incast_128_16_8.bin incast_128_16_16.bin incast_128_16_32.bin incast_128_16_64.bin incast_128_16_128.bin incast_128_16_256.bin incast_128_16_512.bin;
  do
    ...
    CMD="../sim/datacenter/htsim_uec_entry_modern -bonus_drop 0.8 -o uec_entry -nodes 128 -q 118500 -strat ecmp_host_random2_ecn -kmin 20 -target_rtt_percentage_over_base 50 -kmax 80 -linkspeed 100000 -mtu 2048 -seed 44 -queue_type composite -hop_latency 700 -switch_latency 0 -reuse_entropy 1 -goal ${Item} -number_entropies 256 -fast_drop 1 -algorithm delayB -x_gain 0.2 -y_gain 1.25 -w_gain 2 -z_gain 0.8 -use_fast_increase 1 -use_super_fast_increase 1 > ${RES_FOLDER}/${FILE_NAME}"
    echo ${CMD}
    eval ${CMD}
