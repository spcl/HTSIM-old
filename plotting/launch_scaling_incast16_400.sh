...
for Item in incast_128_16_2.bin incast_128_16_4.bin incast_128_16_8.bin incast_128_16_16.bin incast_128_16_32.bin incast_128_16_64.bin incast_128_16_64.bin incast_128_16_256.bin incast_128_16_512.bin;
  do
    echo $Item
...
CMD="python3 scaling.py --folder=SCALING_INCAST_100 --bdp=432000 --folder=${RES_FOLDER} --incast_degree=16"
echo ${CMD}
eval ${CMD}