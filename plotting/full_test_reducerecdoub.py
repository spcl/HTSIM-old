...
# List Experiments
list_experiments = os.listdir('../sim/lgs/input/allreduce_recdoub')
...
for os_rat in list_os:
    if (os_rat == 1):
        FOLDER="400_ALLREDUCERECDOUB_NO_OS_{}".format(1)
    else:
        FOLDER="400_ALLREDUCERECDOUB_OS4:1_{}".format(1)
