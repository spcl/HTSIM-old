...
for Item in incast_128_48_2.bin incast_128_48_4.bin incast_128_48_8.bin incast_128_48_16.bin incast_128_48_32.bin incast_128_48_64.bin incast_128_48_64.bin incast_128_48_256.bin incast_128_48_512.bin;
  do
    echo $Item
...
CMD="python3 scaling.py --folder=SCALING_INCAST_100 --bdp=432000 --folder=${RES_FOLDER} --incast_degree=48"
echo ${CMD}
eval ${CMD}