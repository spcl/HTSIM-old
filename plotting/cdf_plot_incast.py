...
for i, data in enumerate(all_data):
    ax = sns.lineplot(x=data, y=cumulative_probabilities[i], label=labels[i], linewidth = 2, estimator=None)
...
plt.axvline(x=best_time, linestyle='--', color='gray', alpha=0.65, linewidth = 2)

# Add text next to the vertical line
plt.text(best_time + 0.34, 0.37, 'Ideal Completion Time', rotation=90, va='center', color='gray',fontsize=15)
