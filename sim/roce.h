...
class RoceSrc : public BaseQueue, public TriggerTarget {
  ...
  public:
    RoceSrc(RoceLogger *logger, TrafficLogger *pktlogger, EventList &eventlist,
            linkspeed_bps rate);

    virtual void connect(Route *routeout, Route *routeback, RoceSink &sink,
    ...
    void setRate(linkspeed_bps r) {
        _bitrate = r;
        _packet_spacing =
                (simtime_picosec)((Packet::data_packet_size() + roce_acksize) *
