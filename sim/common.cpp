...
int PKT_SIZE_MODERN = 1024;       // Bytes
uint64_t LINK_SPEED_MODERN = 100; // Gb/s
int SINGLE_PKT_TRASMISSION_TIME_MODERN = PKT_SIZE_MODERN * 8 / LINK_SPEED_MODERN;
...
uint64_t MAX_CWD_MODERN_UEC = BDP_MODERN_UEC * 1.0;                       // BDP * 1.2
