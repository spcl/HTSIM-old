...
// longer needed. Note: you never construct a new RcpPacket or RcpAck directly;
...
class RcpPacket : public Packet {
  public:
    ...
    inline static RcpPacket *RcpPacket::newpkt(PacketFlow &flow, route_t &route,
    ...
    const static int DEFAULTDATASIZE =
            1000; // size of a data packet, measured in bytes; used by RcpSrc
  protected:
    seq_t _seqno;
    double _rtt;
...
class RcpAck : public Packet {
  public:
    ...
    inline static RcpAck *RcpAck::newpkt(PacketFlow &flow, route_t &route,
