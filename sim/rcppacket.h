...
class RcpPacket : public Packet {
  public:
    ...
    inline static RcpPacket *RcpPacket::newpkt(PacketFlow &flow, route_t &route, seq_t seqno, int size) {
...
class RcpAck : public Packet {
  public:
    ...
    inline static RcpAck *RcpAck::newpkt(PacketFlow &flow, route_t &route, seq_t seqno, seq_t ackno) {
